...
const MeetupDetails = ({ data }) => {
  ...
  return (
    <div className="flex flex-col items-center md:flex-row">
      ...
      <div className="relative h-[500px] w-[300px] md:w-[500px] md:w-1/4">
        <Image
          src={data.image}
          alt={data.title}
      ...
      <div className="md:ml-5 md:w-3/4 p-5">
        ...
        <div className="flex">
          ...
          <Link href="/" passHref>
            <span className="w-full flex mt-10 items-center justify-end ml-auto cursor-pointer md:w-40 py-2 bg-transparent border-b-2 border-primary text-primary text-lg font-semibold transition-all hover:bg-secondary hover:text-white hover:pr-3 focus:border-4 focus:border-secondary">
              <svg
