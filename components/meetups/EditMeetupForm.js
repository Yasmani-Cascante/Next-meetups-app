...
const EditMeetupForm = ({ previewData, onEditMeetup, loadBtn }) => {
  ...
  return (
    <>
      <p className="text-3xl mb-10 font-semibold leading-7 text-center uppercase mt-10 md:mt-0">
        Edit Meetup
      </p>
      <div className="flex align-center justify-around flex-wrap md:flex-nowrap p-5 w-screen md:w-full ">
        <MeetupItemEditable
          title={titleInput}
          image={imageUrl}
          description={descriptionInput}
          ...
          marker={inputMarker}
        />
        <div className="max-w-2xl p-5 sm:p-8 w-screen">
          <form
            method="post"
          ...
          >
            <div className="md:flex items-center mt-12">
              <div className="w-full md:w-1/2 flex flex-col">
                <label className="font-semibold leading-none" htmlFor="title">
                  Title
                </label>
                <input
                  type="text"
              ...
              <div className="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                <label className="font-semibold leading-none" htmlFor="address">
                  Address
                </label>
                <input
                  type="address"
            ...
            <div className="w-full flex flex-col mt-4">
              <label className="font-semibold leading-none" htmlFor="image">
                Image URL
              </label>
              <input
                type="text"
